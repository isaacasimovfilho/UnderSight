...
>(({ className, variant, ...props }, ref) => {
  return (
    <ToastPrimitives.Root
      className={cn(
        "group pointer-events-auto relative flex w-[350px] items-center justify-between space-x-4 overflow-hidden rounded-md border p-6 pr-8 shadow-lg transition-all",
        {
...
const ToastAction = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<ToastPrimitives.Action>
>(({ className, ...props }, ref) => (
...
const ToastClose = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<ToastPrimitives.Close>
>(({ className, ...props }, ref) => (
...
const ToastTitle = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<ToastPrimitives.Title>
>(({ className, ...props }, ref) => (
...
const ToastDescription = React.forwardRef<
  ...
  React.ComponentPropsWithoutRef<ToastPrimitives.Description>
>(({ className, ...props }, ref) => (
